...
import Id from '@salesforce/schema/Flowhsheet__c.Id';
...
import last3Appointments2 from '@salesforce/apex/ApprovalController.last3Appointments2';
import updateFlowsheets from '@salesforce/apex/ApprovalController.updateFlowsheets';
import returnLatestAppFsRecord from '@salesforce/apex/ApprovalController.returnLatestAppFsRecord2';
...
export default class EditFloiwsheetQA3Componenent extends LightningElement {
    //--------------------------------------------------------------
...
connectedCallback(){
    if (this.recordId) {
       ...
       this._previousTotalMinutes =this.totalPtminutesvalue;

        this._previousTotalOtMinutes = this.totalOtminutesvalue;

        this._previousTotalChiroMinutes =this.totalChiroMinutesValue;

        console.log('pt',this._previousTotalMinutes);
                console.log('ot',this._previousTotalOtMinutes);
                console.log('chiro',this._previousTotalChiroMinutes);
    }
...
//---------------------------------------------------------------
    ...
    callError(){
        ...
        @wire(returnLatestAppFsRecord, { recordId: '$recordId' })//'$visitReason'})visitReasonFull
...
/*
        ...
        this.formfield.othersMin010 =data.FSDiagnostics__c ?? '';
    ...
    return [
       ...
       buttonHandler(event){
        ...
        if(event.target.name=='Clear'){
            ...
            this.comboboxOtherData1 = [ { id: 1, label: 'Other 1', value: '',Min:'',showDelete:true,Pt:false,Chiro:false}   ];
            this.comboboxOtherData2 = [ { id: 1, label: 'Other 1', value: '',Min:'',showDelete:true,Pt:false,Ot:false}   ];
            //this.comboboxOtherData3 = [ { id: 1, label: 'Other 1', value: '',Min:'',showDelete:true,Pt:true,Ot:false}   ];
            this.comboboxOtherData3 = [ { id: 1, label: 'Other 1', value: '',Min:'',showDelete:true,Pt:false,Ot:false}   ];
            this.comboboxOtherData4 = [{ id: 1, label: 'Other 1', value: '',Min:'',showDelete:true,Pt:false,Ot:false,Chiro:false}  ];
            this.comboboxOtherData5 = [{ id: 1, label: 'Other 1', value: '',Min:'',showDelete:true,Pt:false,Ot:false,Chiro:false}  ];
            this.comboboxOtherData6 = [ { id: 1, label: 'Other 1', value: '',Min:'',showDelete:true,Pt:false,Ot:false,Chiro:false}    ];
            this.comboboxOtherData7 = [ { id: 1, label: 'Other 1', value: '',Min:'',showDelete:true,Pt:false,Ot:false,Chiro:false}   ];
            this.comboboxOtherData8 = [ { id: 1, label: 'Other 1', value: '',Min:'',showDelete:true,Pt:false,Ot:false}   ];
            this.comboboxOtherData9 = [ { id: 1, label: 'Other 1', value: '',Min:'',showDelete:true,Pt:false,Ot:false}   ];
            this.comboboxOtherData10 = [ { id: 1, label: 'Other 1', value: '',Min:'',showDelete:true,Pt:false,Ot:false}   ];
        ...
        if(event.target.name=='Next'){
            ...
            this.clearValues()
             ...
             console.log('isTotalMinutesChanged',this.isTotalMinutesChangedflag);
                console.log('isTotalOtMinutesChanged',this.isTotalOtMinutesChangedfalg);
                console.log('isTotalChiroMinutesChanged',this.isTotalChiroMinutesChangedfalg);
                console.log('pt',this._previousTotalMinutes);
                console.log('ot',this._previousTotalOtMinutes);
                console.log('chiro',this._previousTotalChiroMinutes);
                        }
...
otFsId;
chiroFsId;
@wire(last3Appointments2, { recordId: '$recordId', countSize: 3 })
last3Appointments2({ error, data }) {
    if (data) {
        ...
        data.forEach(appointment => {
            ...
            if (appointment.Visit_Reason__c) {
                ...
                if (appointment.Visit_Reason__c.startsWith('PT')) {
                    ...
                    this.ptFsId=appointment.Flowsheet__c;
                    console.log('PT Id is:', this.ptId);
                    console.log('Ptfs id ',appointment.Flowsheet__c);
                    console.log('PT Match found:', this.ptFsId);
                } else if (appointment.Visit_Reason__c.startsWith('OT')) {
                    this.otId = appointment.Id;
                    this.otFsId=appointment.Flowsheet__c;
                    console.log('OT Match found:', this.otId,this.otFsId);
                } else if (appointment.Visit_Reason__c.startsWith('CHIRO')) {
                    this.chiroId = appointment.Id;
                    this.chiroFsId=appointment.Flowsheet__c;
                    console.log('Chiro Match found:', this.chiroId,this.chiroFsId);
                }
            }
        });
...
getPtItemsFormatted1(flag, data) {
  if (!flag || !Array.isArray(data)) return null;
...
getOtItemsFormatted1(flag, data) {
      if (!flag || !Array.isArray(data)) return null;
    return data
        .filter(item => item.Ot)
        .map(item => `${item.value}-${item.Min} Minutes`)
...
getChiroItemsFormatted1(flag, data) {
      if (!flag || !Array.isArray(data)) return null;
    return data
        .filter(item => item.Chiro)
        .map(item => `${item.value}-${item.Min} Minutes`)
...
getChiroItemsFormatted(flag, data) {
      if (!flag || !Array.isArray(data)) return null;
    return data
        .filter(item => item.Chiro)
        .map(item => `${item.value}-${item.Min} Minutes`)
...
SubmitHandler(){
 ...
 if ( this.ptId)  {
    ...
    const fields1 = {};
    fields1[Id.fieldApiName]=this.ptFsId;
        ...
        //---------------------------   
         ...
         const Otvalues1=this.getPtItemsFormatted1(this.formfield.checkbox1,this.comboboxOtherData1);
         ...
         inputs1=[...inputs1,(Otvalues1 != '')? Otvalues1 : ''];
            ...
            //-------------------------------------
             //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
         const Otvalues2=this.getPtItemsFormatted1(this.formfield.checkbox2,this.comboboxOtherData2);
        ...
        //---------
       //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
       const ptvalues3=this.getPtItemsFormatted1(this.formfield.checkbox3,this.comboboxOtherData3);
       ...
       inputs1=[...inputs1,(ptvalues3 != '')? ptvalues3 : ''];
         ...
         //---------------------------------------------------------
            ...
            //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
            const Otvalues=this.getPtItemsFormatted1(this.formfield.checkbox4,this.comboboxOtherData4);
 ...
 //----------------------------------------------------------------------
    ...
    fields1[MinutesSpent5.fieldApiName] = this.formfield.minutesSpent5;
     //---------
       //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
       const ptvalues5=this.getPtItemsFormatted1(this.formfield.checkbox5,this.comboboxOtherData5);
    ...
    //-------------------------------------
     //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
 const Ptvalues2=this.getPtItemsFormatted1(this.formfield.checkbox6,this.comboboxOtherData6);
 ...
 inputs1=[...inputs1,(Ptvalues2 != '')? Ptvalues2 : ''];
    ...
    fields1[MinutesSpent7.fieldApiName] = this.formfield.minutesSpent7;
     //---------
       //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
       const ptvalues7=this.getPtItemsFormatted1(this.formfield.checkbox7,this.comboboxOtherData7);
 ...
 //----------------------------------------------------------------------
    ...
    console.log('***Created Inputs are',inputs1);
    
     fields1[Total_Units.fieldApiName]=this.totalPtunitsValue1;//this.sumUnitscalculator(inputs1);


        console.log('&& entered to here 2');

    

     //const recordInput={fields1}
     
     const recordInput = { fields: fields1 };
        updateRecord(recordInput).then(() => {
            ...
            this.status='Aproval sucess'
             console.log('***Record updated Successfully:');
                ...
                Flowsheet_Approved__c: false,
                Flowsheet_Updated__c: true
            };

            // If flag is false, we don’t touch Appointment_Status__c etc.
            if (!this.isTotalMinutesChangedflag) {
                delete fields.Appointment_Status__c;
                delete fields.Flowsheet_Approved__c;
        //      delete fields.Flowsheet_Updated__c;
            }

            updateRecord({ fields })
                .then(() => {
                    this.status = 'Approval success';
                    console.log('*** Record updated successfully');
                    // this.showToast('Success', 'Record updated successfully', 'success');
                })
                .catch(error => {
                    this.status = 'Approval failed';
                    console.error('*** Record update failed', JSON.stringify(error));
        ...
        .catch(error => {
            ...
            this.status='Aproval failed'
                console.log('&& entered to here -failed',JSON.stringify(error));

            this.showToast('Error', 'Record failed at flowsheet\',this.ptFsId', 'error');
        });
...
if (this.otId)  {
    ...
    const fields1 = {};
    fields1[Id.fieldApiName]=this.otFsId;
    ...
    //-------------------------------------
     //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
 const Otvalues2=this.getOtItemsFormatted1(this.formfield.checkbox2,this.comboboxOtherData2);
 fields1[otherExercises2.fieldApiName]=Otvalues2;
 //fields1[otherExercisesUnits1.fieldApiName]=
 fields1[otherExercisesUnits2.fieldApiName]=(Otvalues2 != '')? this.calculateUnits(Otvalues2) : '';
 // fields1[MinutesTotal1.fieldApiName]=this.sumUnits( [(this.formfield.minutesSpent1 != '')? this.formfield.minutesSpent1 : '',(this.formfield.othersMin01 != '')? this.formfield.othersMin01 : '']);
 ...
 inputs2=[...inputs2,(Otvalues2 != '')? Otvalues2 : ''];
    ...
    //--------------------------------------------------
     //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
     const Otvalues1=this.getOtItemsFormatted1(this.formfield.checkbox3,this.comboboxOtherData3);
    ...
    //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
    const Otvalues=this.getOtItemsFormatted1(this.formfield.checkbox4,this.comboboxOtherData4);
    ...
    inputs2=[...inputs2,(Otvalues != '')? Otvalues : ''];
        ...
        //-------------------------------------
         //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
     const Otvalues5=this.getOtItemsFormatted1(this.formfield.checkbox5,this.comboboxOtherData5);
     fields1[otherExercises5.fieldApiName]=Otvalues5;
     //fields1[otherExercisesUnits1.fieldApiName]=
     fields1[otherExercisesUnits5.fieldApiName]=(Otvalues5 != '')? this.calculateUnits(Otvalues5) : '';
     // fields1[MinutesTotal1.fieldApiName]=this.sumUnits( [(this.formfield.minutesSpent1 != '')? this.formfield.minutesSpent1 : '',(this.formfield.othersMin01 != '')? this.formfield.othersMin01 : '']);
     fields1[MinutesTotal5.fieldApiName]=this.sumUnits( [(Otvalues5 != '')? Otvalues5 : '']);
     //fields1[UnitsSpentcalucation1.fieldApiName]=(this.formfield.minutesSpent1 != '')? this.calculateUnits(this.formfield.minutesSpent1) : '';
     fields1[UnitsSpentcalucation5.fieldApiName]=(Otvalues5 != '')? this.calculateUnits(Otvalues5) : '';
     //fields1[UnitsTotal1.fieldApiName]=this.sumUnits([(this.formfield.minutesSpent1 != '')? this.calculateUnits(this.formfield.minutesSpent1) : '',(this.formfield.othersMin01 != '')? this.calculateUnits(this.formfield.othersMin01) : '']);
     fields1[UnitsTotal5.fieldApiName]=this.sumUnits([(Otvalues5 != '')? this.calculateUnits(Otvalues5) : '']);
     //inputs1=[...inputs1,(this.formfield.minutesSpent1 != '')? this.formfield.minutesSpent1 : '',(this.formfield.othersMin01 != '')? this.formfield.othersMin01 : ''];
     inputs2=[...inputs2,(Otvalues5 != '')? Otvalues5 : ''];
    ...
    //-------------------------------------
     //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
 const Otvalues6=this.getOtItemsFormatted1(this.formfield.checkbox6,this.comboboxOtherData6);
 fields1[otherExercises6.fieldApiName]=Otvalues6;
 //fields1[otherExercisesUnits1.fieldApiName]=
 fields1[otherExercisesUnits6.fieldApiName]=(Otvalues6 != '')? this.calculateUnits(Otvalues6) : '';
 // fields1[MinutesTotal1.fieldApiName]=this.sumUnits( [(this.formfield.minutesSpent1 != '')? this.formfield.minutesSpent1 : '',(this.formfield.othersMin01 != '')? this.formfield.othersMin01 : '']);
 fields1[MinutesTotal6.fieldApiName]=this.sumUnits( [(Otvalues6 != '')? Otvalues6 : '']);
 //fields1[UnitsSpentcalucation1.fieldApiName]=(this.formfield.minutesSpent1 != '')? this.calculateUnits(this.formfield.minutesSpent1) : '';
 fields1[UnitsSpentcalucation6.fieldApiName]=(Otvalues6 != '')? this.calculateUnits(Otvalues6) : '';
 //fields1[UnitsTotal1.fieldApiName]=this.sumUnits([(this.formfield.minutesSpent1 != '')? this.calculateUnits(this.formfield.minutesSpent1) : '',(this.formfield.othersMin01 != '')? this.calculateUnits(this.formfield.othersMin01) : '']);
 fields1[UnitsTotal6.fieldApiName]=this.sumUnits([(Otvalues6 != '')? this.calculateUnits(Otvalues6) : '']);
 //inputs1=[...inputs1,(this.formfield.minutesSpent1 != '')? this.formfield.minutesSpent1 : '',(this.formfield.othersMin01 != '')? this.formfield.othersMin01 : ''];
 inputs2=[...inputs2,(Otvalues6 != '')? Otvalues6 : ''];
    ...
    fields1[MinutesSpent7.fieldApiName] = this.formfield.minutesSpent7;
     //---------
       //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
       const Otvalues7=this.getOtItemsFormatted1(this.formfield.checkbox7 ,this.comboboxOtherData7);
    ...
    //-----------
     ...
     const recordInput2={fields: fields1}
        updateRecord(recordInput2).then(() => {
            // Handle success, show success toast or message
            //this.showToast('Success', 'Record Cretated  successfully', 'success');
            this.status='Aproval sucess'
             console.log('***Record updated Successfully:OT Values');
...
// If flag is false, we don’t touch Appointment_Status__c etc.
if (!this.isTotalOtMinutesChangedfalg) {
    delete fields.Appointment_Status__c;
    delete fields.Flowsheet_Approved__c;
//  delete fields.Flowsheet_Updated__c;
}
...
updateRecord({ fields })
    .then(() => {
        this.status = 'Approval success';
        console.log('*** OT record updated successfully');
        // this.showToast('Success', 'OT record updated successfully', 'success');
    })
    .catch(error => {
        this.status = 'Approval failed';
        console.error('*** OT record update failed', JSON.stringify(error));
        // this.showToast('Error', error.body.message, 'error');
    });
...
if (this.chiroId) {
    const fields1 = {};
    let inputs3=[];
        fields1[Id.fieldApiName]=this.chiroFsId;//'a0EU8000002EioEMAS'; //this.recordId;
...
//-------------------------------------------------
    ...
    const Chirovalues=this.getChiroItemsFormatted1(this.formfield.checkbox1,this.comboboxOtherData1);
    ...
    console.log('Entered here');
    //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
    const Otvalues=this.getChiroItemsFormatted1(this.formfield.checkbox4,this.comboboxOtherData4);
    console.log('Exited here');
    ...
    fields1[MinutesSpent5.fieldApiName] = this.formfield.minutesSpent5;
     //---------
       //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
       const ptvalues5=this.getChiroItemsFormatted1(this.formfield.checkbox5,this.comboboxOtherData5);
       fields1[otherExercises5.fieldApiName]=ptvalues5;
       //fields1[otherExercisesUnits1.fieldApiName]=
       fields1[otherExercisesUnits5.fieldApiName]=(ptvalues5 != '')? this.calculateUnits(ptvalues5) : '';
       // fields1[MinutesTotal1.fieldApiName]=this.sumUnits( [(this.formfield.minutesSpent1 != '')? this.formfield.minutesSpent1 : '',(this.formfield.othersMin01 != '')? this.formfield.othersMin01 : '']);
...
//-------------------------------------------------
    ...
    //-------------------------------------
     //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
 const Otvalues2=this.getChiroItemsFormatted1(this.formfield.checkbox6,this.comboboxOtherData6);
 ...
 inputs3=[...inputs3,(Otvalues2 != '')? Otvalues2 : ''];
    ...
    fields1[MinutesSpent7.fieldApiName] = this.formfield.minutesSpent7;
     //---------
       //fields1[otherExercises1.fieldApiName]=this.formfield.othersMin01;
       const Otvalues7=this.getChiroItemsFormatted1(this.formfield.checkbox7,this.comboboxOtherData7);
       fields1[otherExercises7.fieldApiName]=Otvalues7;
       //fields1[otherExercisesUnits1.fieldApiName]=
       fields1[otherExercisesUnits7.fieldApiName]=(Otvalues7 != '')? this.calculateUnits(Otvalues7) : '';
       // fields1[MinutesTotal1.fieldApiName]=this.sumUnits( [(this.formfield.minutesSpent1 != '')? this.formfield.minutesSpent1 : '',(this.formfield.othersMin01 != '')? this.formfield.othersMin01 : '']);
    ...
    const recordInput3 = {  fields: fields1 };

        updateRecord(recordInput3).then(() => {
            // Handle success, show success toast or message
            //this.showToast('Success', 'Record Cretated  successfully', 'success');
            this.status='Aproval sucess'
             console.log('***Record updated Successfully:Chiro Values');
...
// If flag is false, we don’t touch Appointment_Status__c etc.
if (!this.isTotalChiroMinutesChangedfalg) {
    delete fields.Appointment_Status__c;
    delete fields.Flowsheet_Approved__c;
//  delete fields.Flowsheet_Updated__c;
}
...
updateRecord({ fields })
    .then(() => {
        this.status = 'Approval success';
        console.log('*** Chiro record updated successfully');
        // this.showToast('Success', 'Chiro record updated successfully', 'success');
    })
    .catch(error => {
        this.status = 'Approval failed';
        console.error('*** Chiro record update failed', JSON.stringify(error));
        // this.showToast('Error', error.body.message, 'error');
    });
...
get totalPtminutesvalue() {
    ...
    const currentValue = this.sumUnits2(totalInputs);



    if (this._initialLoad) {
        //this._previousTotalMinutes = currentValue;
        this._initialLoad = false;
        this.isTotalMinutesChanged = false;
        console.log('compoent is loaded');
    } else {
        this.isTotalMinutesChanged = currentValue !== this._previousTotalMinutes;
        //this._previousTotalOtMinutes = currentValue; // 🔑 always update
    }
    return currentValue;
}
...
isTotalOtMinutesChanged = false;
_otInitialLoad = true;
_previousTotalOtMinutes ;
...
get totalOtminutesvalue() {
    ...
    const currentValue = this.sumUnits2(totalInputs);
     ...
     if (this._otInitialLoad) {
       // this._previousTotalOtMinutes = currentValue;
        this._otInitialLoad = false;
        this.isTotalOtMinutesChanged = false;
    } else {
        this.isTotalOtMinutesChanged = currentValue !== this._previousTotalOtMinutes;
        //this._previousTotalOtMinutes = currentValue; // 🔑 always update
    }
...
isTotalChiroMinutesChanged = false;
_chiroInitialLoad = true;
_previousTotalChiroMinutes;
...
get totalChiroMinutesValue() {
    ...
    const currentValue = this.sumUnits2(totalInputs);
     ...
     if (this._chiroInitialLoad) {
        //this._previousTotalChiroMinutes = currentValue;
        this._chiroInitialLoad = false;
        this.isTotalChiroMinutesChanged = false;
    } else {
        this.isTotalChiroMinutesChanged = currentValue !== this._previousTotalChiroMinutes;
        //this._previousTotalChiroMinutes = currentValue; // 🔑 always update
    }
...
//-------------------------------
get isTotalMinutesChangedflag(){
return this._previousTotalMinutes==this.totalPtminutesvalue?false:true;
}

get  isTotalOtMinutesChangedfalg(){
return this._previousTotalOtMinutes ==this.totalOtminutesvalue?false:true;
}

get  isTotalChiroMinutesChangedfalg(){
return this._previousTotalChiroMinutes ==this.totalChiroMinutesValue?false:true;
}
