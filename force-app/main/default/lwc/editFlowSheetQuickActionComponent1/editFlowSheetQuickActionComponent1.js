...
export default class EditFlowSheetQuickActionComponent1 extends LightningElement {
        ...
        get nonEmptyMinutesSpent() {
            ...
            switch (index) {
                ...
                case '10':
                    ...
                    break;
                case '01':
                        formattedKey = 'Other exercises(97110)';
                        break;

                        case '02':
                            formattedKey = 'Other exercises(97530)';
                            break;

                            case '03':
                                formattedKey = 'Other exercises(97112)';
                                break;

                                case '04':
                                    formattedKey = 'Other exercises(97140)';
                                    break;

                                    case '05':
                                        formattedKey = 'Other exercises(99750)';
                                        break;

                                        case '06':
                                            formattedKey = 'Other exercises(97012)';
                                            break;
...
@track comboboxOtherData1 = [  ];
@track comboboxOtherData2 = [  ];
@track comboboxOtherData3 = [  ];
@track comboboxOtherData4 = [  ];
@track comboboxOtherData5 = [  ];
@track comboboxOtherData6 = [  ];
@track comboboxOtherData7 = [  ];
@track comboboxOtherData8 = [  ];
@track comboboxOtherData9 = [  ];
@track comboboxOtherData10 = [  ];
...
get totalminutesvalue() {
    ...
    return this.sumUnits(totalInputs);
}
...
get totalminutesvalueCPT1() {
    ...
    return this.sumUnits(totalInputs1);
}
...
calculateUnitsFromMinutes(totalMinutes) {
    if (totalMinutes > 0 && totalMinutes <= 22) {
        return 1;
...
deleteHandlerOther2(event){
    ...
    console.log(this.formfield.others2);
    }
...
deleteHandlerOther3(event){
    ...
    console.log(this.formfield.others3);
    }
...
deleteHandlerOther4(event){
    ...
    console.log(this.formfield.others4);
    }
...
deleteHandlerOther6(event){
    ...
    console.log(this.formfield.others6);
    }
