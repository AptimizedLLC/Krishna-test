...
import getARRecords from '@salesforce/apex/ARListViewController.getARRecords';
import updateARRecords from '@salesforce/apex/ARListViewController.updateARRecords';
...
export default class ArListView extends LightningElement {
    ...
    columns = [
        ...
        { label: 'Current Insurance', fieldName: 'AR_Payer__c', type: 'text', editable: false,initialWidth: 150, sortable: true },
        { label: 'Aging Bucket', fieldName: 'AR_Age_by_Last_Billed__c', type: 'text', editable: false,initialWidth: 140 },
    ...
    get archivedVariant() { return this.selectedStatus === 'Archived' ? 'brand' : 'neutral'; }
}